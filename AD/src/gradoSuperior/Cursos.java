 ...
 */
public class Cursos extends gradoSuperior.Clases {
    ...
    private static int CID = com.matisse.MtDatabase.allocCID(new com.matisse.reflect.MtClass.Loader("gradoSuperior.Cursos"));

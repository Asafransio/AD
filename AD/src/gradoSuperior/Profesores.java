...
public class Profesores extends com.matisse.reflect.MtObject {
    ...
    private static int CID = com.matisse.MtDatabase.allocCID(new com.matisse.reflect.MtClass.Loader("gradoSuperior.Profesores"));
     ...
     * @see #removeImparte
     */
    public final gradoSuperior.Clases[] getImparte() {
        return (gradoSuperior.Clases[])getSuccessors(getImparteRelationship(getMtDatabase()), gradoSuperior.Clases.class);
    }
    ...
    public final <E extends com.matisse.reflect.MtObject> com.matisse.MtObjectIterator<E> imparteIterator() {
        return this.<E>successorIterator(getImparteRelationship(getMtDatabase()), gradoSuperior.Clases.class);
    }
     ...
     * @see #removeImparte
     */
    public final void setImparte(gradoSuperior.Clases[] succs) {
     ...
     * @see #removeImparte
     */
    public final void prependImparte(gradoSuperior.Clases succ) {
     ...
     * @see #imparteIterator
     */
    public final void appendImparte(gradoSuperior.Clases succ) {
     ...
     * @see #imparteIterator
     */
    public final void appendImparte(gradoSuperior.Clases[] succs) {
     ...
     * @see #imparteIterator
     */
    public void removeImparte(gradoSuperior.Clases[] succs) {
     ...
     * @see #imparteIterator
     */
    public void removeImparte(gradoSuperior.Clases succ) {
